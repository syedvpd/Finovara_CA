    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-white rounded-3xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto relative" onClick={e => e.stopPropagation()}>
        ...
        <div className="h-64 rounded-xl overflow-hidden mb-8 bg-[#EEF1F5]">
          <img src={article.image || article.cover || article.cover_image_url || "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&h=400&fit=crop"} alt="Article Cover" className="w-full h-full object-cover" />
        </div>
