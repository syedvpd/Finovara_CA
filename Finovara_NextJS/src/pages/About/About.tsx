"use client";
import { Clock, Target, UserCheck, Lock, Search, TrendingUp, Heart, Shield, BookOpen, FileCheck, PieChart, Flag, MapPin, Building2, Lightbulb, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-5xl font-extrabold text-white mb-6" style={{ fontFamily: "Manrope" }}>
              A Decade of Financial <span style={{ color: "#C8A45D" }}>Excellence</span>
            </h1>
            ...
            <p className="text-white/60 leading-relaxed mb-8" style={{ fontFamily: "Inter" }}>
              From our foundation as a boutique tax practice, we have grown into a comprehensive financial services firm with 65+ professionals serving 1,500+ clients across 15 sectors.
            </p>
          ...
          <div>
            <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=600&h=450&fit=crop&auto=format"
              alt="Finovara team" className="rounded-3xl shadow-2xl w-full object-cover" />
          </div>
        </div>
      </section>
            ...
            {team.map(({ name, role, exp, spec, initials }) => (
              <div key={name} className="group bg-white rounded-2xl p-6 border border-[#E2E8F0] hover:shadow-xl transition-all hover:-translate-y-1">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center font-bold text-xl text-white mb-4"
                  style={{ background: "linear-gradient(135deg, #102A43, #087F5B)", fontFamily: "Manrope" }}>{initials}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#087F5B]/20 shadow-[0_8px_30px_rgba(8,127,91,0.08)] relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#087F5B]/5 rounded-bl-full -mr-8 -mt-8"></div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {["Hyderabad", "Bengaluru", "Vijayawada", "Visakhapatnam", "Chennai", "Pune"].map((city) => (
