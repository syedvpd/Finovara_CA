...
export const SERVICES = [
  { icon: FileText, title: "Income Tax", desc: "Strategic tax planning, ITR filing, assessments, and appeals for individuals and corporates.", features: ["Individual tax returns", "Business tax returns", "Tax planning", "Advance-tax calculations", "TDS compliance", "Tax notices", "Tax assessments", "Tax advisory"], portalFeatures: ["Select financial year", "Upload Form 16 / 15", "Upload bank statements", "Upload investment proofs", "Assign tax consultant", "Track preparation status", "Download acknowledgement", "Receive tax reminders"] },
  { icon: FileCheck, title: "GST Services", desc: "GST registration, monthly/quarterly returns, audits, and advisory services.", features: ["GST registration", "GST return filing", "GST reconciliation", "GST audit support", "E-invoice assistance", "E-way bill advisory", "GST notice support", "Input-tax-credit review"], deliverables: ["Filing report", "Reconciliation report", "Liability summary", "Pending-document list", "Return acknowledgement", "Compliance calendar"] },
  { icon: Shield, title: "Audit & Assurance", desc: "Statutory, internal, and tax audits ensuring compliance and financial integrity.", features: ["Statutory audit", "Internal audit", "Tax audit", "Stock audit", "Concurrent audit", "Process audit", "Compliance audit", "Management audit"], workflow: [{ step: "Assignment", desc: "Initial onboarding, scope definition, and team allocation." }, { step: "Document Request", desc: "Secure request list generated for required financial and operational data." }, { step: "Document Submission", desc: "Client uploads requested documents securely via the portal." }, { step: "Verification", desc: "Detailed vouching, verification, and analytical procedures by the audit team." }, { step: "Observation Recording", desc: "Documenting preliminary findings, control gaps, and exceptions." }, { step: "Management Response", desc: "Discussion of observations with management to incorporate their feedback." }, { step: "Draft Report", desc: "Preparation of draft financials and audit report for review." }, { step: "Partner Review", desc: "Final quality review by the engagement partner." }, { step: "Final Audit Report", desc: "Signing and delivery of the final audit report and deliverables." }] },
  { icon: BarChart2, title: "Accounting & Bookkeeping", desc: "Comprehensive accounting, MIS reporting, and financial statement preparation.", features: ["Monthly bookkeeping", "Ledger management", "Bank reconciliation", "Vendor reconciliation", "Customer reconciliation", "Financial statements", "MIS reporting", "Year-end closing"] },
  { icon: Building2, title: "Company Incorporation", desc: "End-to-end company formation, ROC compliances, and corporate structuring.", features: ["Private limited company support", "LLP registration support", "Partnership registration support", "Startup documentation", "Annual filings", "Director-related compliance", "Registered-office support", "Corporate record maintenance"] },
  { icon: Users, title: "Payroll Management", desc: "Complete payroll processing, PF, ESI, TDS, and statutory compliance.", features: ["Employee master", "Salary structures", "Attendance imports", "Payroll processing", "Payslip generation", "TDS calculation", "PF and ESI support", "Reimbursement records", "Payroll reports"] },
  { icon: TrendingUp, title: "Virtual CFO", desc: "Strategic financial leadership, fundraising support, and board-level advisory.", features: ["Financial strategy", "Cash-flow management", "Budget planning", "MIS review", "Profitability analysis", "Investor reporting", "Cost optimization", "Management dashboard"] },
  { icon: Lightbulb, title: "Startup Advisory", desc: "DPIIT registration, funding advisory, pitch deck review, and compliance setup.", features: ["Entity selection", "Compliance roadmap", "Financial projections", "Investor documentation", "Cap-table support", "Business-plan financials", "Tax planning", "Accounting setup"] },
  { icon: Target, title: "Financial Due Diligence", desc: "Deep-dive financial reviews for M&A, investments, and partnership decisions.", deliverables: ["Financial analysis", "Revenue verification", "Liability assessment", "Tax-risk review", "Working-capital analysis", "Compliance-gap report", "Transaction-risk report", "Final due-diligence report"] },
  { icon: Layers, title: "Risk & Internal Controls", desc: "Risk frameworks, control testing, and governance advisory for enterprises.", features: ["Process review", "Internal-control evaluation", "Fraud-risk analysis", "Approval-matrix design", "SOP documentation", "Risk register", "Control-testing report", "Corrective-action tracking"] },
];
...
export const TESTIMONIALS = [
  { name: "Rajesh Mehta", role: "CEO, TechCorp India", rating: 5, text: "Finovara transformed our financial operations. Their Virtual CFO service gave us the strategic clarity we needed to scale from ₹10Cr to ₹85Cr revenue in three years. Exceptional expertise.", avatar: "RM" },
  { name: "Priya Sharma", role: "Founder, Greenleaf Organics", rating: 5, text: "The GST advisory team at Finovara saved us lakhs in penalties through proactive compliance management. Their portal makes document management effortless.", avatar: "PS" },
  { name: "Anil Kapoor", role: "CFO, BuildRight Infrastructure", rating: 5, text: "Outstanding audit quality and turnaround time. Their team's understanding of the construction sector is unmatched. We've been clients for 7 years and counting.", avatar: "AK" },
  { name: "Sunita Reddy", role: "Director, MedCare Hospitals", rating: 5, text: "Finovara's expertise in healthcare sector compliance is exceptional. They handle our multi-entity consolidation and NABH compliance seamlessly.", avatar: "SR" },
  { name: "Vikram Nair", role: "Partner, Apex Ventures", rating: 5, text: "Their financial due diligence reports are thorough, incisive, and decision-ready. We rely on Finovara for every M&A transaction we evaluate.", avatar: "VN" },
];

export const INSIGHTS = [
  { tag: "Tax Update", date: "15 Jan 2025", title: "Budget 2025: Key Changes Affecting Indian Businesses", excerpt: "A comprehensive breakdown of the Union Budget announcements impacting corporate tax, capital gains, and startup incentives.", readTime: "8 min read" },
  { tag: "GST Advisory", date: "08 Jan 2025", title: "New GST Return Filing Mechanism: What You Need to Know", excerpt: "Understanding the revised GST filing procedures and how businesses should prepare for the updated compliance framework.", readTime: "6 min read" },
  { tag: "Financial Planning", date: "02 Jan 2025", title: "Virtual CFO vs In-House CFO: The 2025 Decision Guide", excerpt: "A detailed cost-benefit analysis helping growing businesses decide between hiring full-time financial leadership or outsourcing.", readTime: "10 min read" },
];

export const FAQS = [
  { q: "What is the difference between a CA and a Virtual CFO?", a: "A Chartered Accountant typically handles compliance — tax filings, audits, and accounting. A Virtual CFO provides strategic financial leadership: financial planning, fundraising advisory, investor relations, and board-level guidance, without the cost of a full-time hire." },
  { q: "How secure is the Finovara client portal?", a: "Our portal uses 256-bit AES encryption, two-factor authentication, role-based access controls, and ISO 27001-compliant infrastructure. All document transfers are end-to-end encrypted and audit-logged." },
  { q: "What industries does Finovara specialise in?", a: "We serve 15+ industries including IT, Manufacturing, Healthcare, Real Estate, Retail, Education, Pharmaceuticals, NGOs, Startups, and Export businesses. Each sector team has dedicated specialists." },
  { q: "How quickly can I onboard with Finovara?", a: "Our streamlined onboarding process takes 48-72 hours. After the initial consultation, we assign your dedicated relationship manager, set up portal access, and begin compliance review immediately." },
  { q: "Do you offer services for startups and early-stage companies?", a: "Absolutely. Our Startup Advisory package covers DPIIT registration, company incorporation, seed funding compliance, ESOP structuring, startup-friendly accounting, and pitch deck financial modelling." },
  { q: "What are your fee structures?", a: "We offer transparent, milestone-based pricing across retainer, project, and hourly engagement models. Every engagement begins with a clear scope of work and fixed deliverables so there are no billing surprises." },
];
