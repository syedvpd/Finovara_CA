      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#E2E8F0] shadow-sm">
          <div className="flex items-center gap-4 mb-6 border-b border-white/10 pb-8">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-extrabold text-white" style={{ fontFamily: "Manrope" }}>
                {title}
              </h1>
              <p className="text-sm text-[#94A3B8] mt-1" style={{ fontFamily: "Inter" }}>
                Last updated: {lastUpdated}
              </p>
            </div>
          </div>

          <div className="prose prose-lg max-w-none text-[#94A3B8] prose-headings:font-bold prose-headings:text-white leading-relaxed" style={{ fontFamily: "Inter" }}>
            {isPrivacy ? (
              <>
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>1. Information We Collect</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>2. How We Use Your Information</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>3. Data Security</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>4. Your Rights</h3>
                <p className="mb-6">
              ...
              <>
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>1. Acceptance of Terms</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>2. Professional Services Disclaimer</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>3. User Obligations</h3>
                <p className="mb-6">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-4" style={{ fontFamily: "Manrope" }}>4. Limitation of Liability</h3>
                <p className="mb-6">
