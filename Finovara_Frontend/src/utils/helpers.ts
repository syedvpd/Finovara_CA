...
<body>
  ...
  <div class="container">
    ...
    if (title === "Compliance Checklist") {
      ...
      body = `<p class="lead">Never miss a deadline again. This calendar covers crucial tax and regulatory filings.</p>
      <div class="grid">
        ${COMPLIANCE_CALENDAR.map(item => `
          <div class="card">
            <h3>${item.task} <span style="font-size: 12px; background: #EAF4F0; color: #087F5B; padding: 2px 8px; border-radius: 12px; vertical-align: middle;">${item.type}</span></h3>
